...
Subsurface Profile [Subsurface'e](#subsurface) ve [Preintegrated Skin'e](#preintegrated-skin) çok benzer ama "higher-end skin rendering" yani deri yüzeyi rendering üzerine tasarlanmıştır. Eger insan derisi yapacaksanız en iyi Shading Model budur (en pahalı olan da).
