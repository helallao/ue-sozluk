...
Subsurface Profile [Subsurface'e](#subsurface) ve [Preintegrated Skin'e](#preintegrated-skin) çok benzer. Tek farkı "higher-end skin rendering" yani deri yüzeyi rendering üzerine tasarlanmış olması, eger insan derisi yapacaksanız en iyi Shading Model budur.
