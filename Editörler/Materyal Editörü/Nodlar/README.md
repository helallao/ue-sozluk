...
* #### [VertexInterpolator]() 💝
Verilen inputu [Pixel Shader'dan Vertex shader](../Terimler%20Sözlügü#vertex-shader-ve-pixel-shader) moduna alır. Bu nodu kullanmak performans açısından iyi olabilir.
